...
| Предмет | Путь | Статус |
|---|---|---|
| Чайная связка степи | `content/items/shadow-shard/ash-steppe/chaynaya-svyazka.md` | draft-clean-card |
| Караванная метка | `content/items/shadow-shard/ash-steppe/karavannaya-metka.md` | draft-clean-card |
| Пылевая карта | `content/items/shadow-shard/ash-steppe/pylevaya-karta.md` | draft-clean-card |
| Фонарь сторожа | `content/items/shadow-shard/ash-steppe/fonar-mayachnogo-storozha.md` | draft-clean-card |
