...
|---|---|---|
| Гравен Холлоу | `content/cities/middle-lands/common/graven-hollou.md` | draft-clean-card |
| Морнстэд | `content/cities/middle-lands/common/mornsted.md` | draft-clean-card |
| Кладовая Перекрёстков | `content/cities/middle-lands/common/kladovaya-perekrestkov.md` | draft-clean-card |
| Фарн’Крот | `content/cities/middle-lands/common/farnkrot.md` | draft-clean-card |
| Озерник | `content/cities/middle-lands/common/ozernik.md` | draft-clean-card |
| Плавень | `content/cities/middle-lands/common/plaven.md` | draft-clean-card |
